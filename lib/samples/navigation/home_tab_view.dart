...
import 'package:rive_ui/components/hcard.dart';
import 'package:rive_ui/components/vcard.dart';
                ...
                children: _courses
                    .map(
                      (course) => Padding(
                        ...
                        child: VcardWidgets(course: course),
                      ),
                    )
                    .toList(),
              ),
              ...
              child: Wrap(
                children: List.generate(
                  ...
                  (index) => Container(
                    ...
                    child: HcardWidget(section: _courseSections[index]),
                  ),
                ),
              ),
            ),
